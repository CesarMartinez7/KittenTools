...
export const ModalViewer = () => {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white p-6 flex flex-col gap-8 items-center justify-center">
...
export const TextDiffViewer: React.FC<Props> = ({ texto1, texto2 }) => {
    ...
    return (
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 font-mono text-sm">
        ...
        <div>
          <h2 className="gradient-text font-semibold text-zinc-400 ">Diferencias</h2>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {e.lineasBien.map((wordDiff: any, idx: number) => (
                      ...
                      >
                        ...
                        {wordDiff.valueLeft || <span className="italic opacity-50">[vacio]</span>}
                      </span>
                    ))}
                  </div>
                  <div className="flex flex-wrap gap-2 mt-2">
                    {e.lineasBien.map((wordDiff: any, idx: number) => (
                      ...
                      >
                        ...
                        {wordDiff.valueRight || <span className="italic opacity-50">[vacio]</span>}
                      </span>
                    ))}
                  </div>
                </div>
