...
export default function ResultadoJsonFormat ({handleClickOpenModal, value, openAll} : JsonFormatProps) {
    return( <section className="rounded-xl backdrop-blur  shadow-2xl bg-zinc-900/80 p-6 flex flex-col gap-y-3">
