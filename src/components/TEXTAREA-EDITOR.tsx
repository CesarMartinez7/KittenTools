...
export default function ContainerTextArea ({setValue, value, classText} : ContainerArea) {
    return(
        <section className={`rounded-xl shadow-2xl backdrop-blur-3xl p-6 space-y-4 flex flex-col gap-1  bg-zinc-900/80 ${classText} `}>
